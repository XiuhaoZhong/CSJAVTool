...
LRESULT WindowImplBase::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	if (pControl) {
		...
		pCloseBtn->AttachClick(nbase::Bind(&WindowImplBase::closeClickedPrint,this));
	}
...
bool WindowImplBase::closeClickedPrint() {
	std::cout << "this is the second event on close btn" << std::endl;
